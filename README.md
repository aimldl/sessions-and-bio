...
T Kim is a Machine Learning Solution Lead at Google Cloud where he helps users leverage the power of AI Hypercomputer... [Your English Bio]
...
김태형 박사는 Google Cloud의 머신러닝 솔루션 리드입니다. 글로벌 스케일의 AI 프로젝트를 성공적으로 이끈 경험을 바탕으로... [Your Korean Bio]
...
**Google Cloud, 機械学習ソリューションリード**

金 泰亨(キム・テヒョン)博士は、Google Cloudの機械学習ソリューションリードです。グローバルスケールでのAIプロジェクトを成功に導いた経験を基に... [Your Japanese Bio]
